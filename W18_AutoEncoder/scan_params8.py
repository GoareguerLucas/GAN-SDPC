...
params = {"--b1": [0.7,0.7,0.7], "--eps": [0.0,0.1,0.1], "--lrelu": [0.01,0.01,0.000001], "--kernels_size": [9,9,9], "--padding": [4,4,4], "--model_save_path": ["models_eps0.0lrelu0.01","models_eps0.1lrelu0.01","models_eps0.1lrelu0.000001"]}
