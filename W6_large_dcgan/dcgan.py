...
class Generator(nn.Module):
	def __init__(self):
		...
		self.conv1 = generator_block(1024, 512, kernel=5, stride=2),
		self.conv2 = generator_block(512, 256, kernel=5, stride=2),
		self.conv3 = generator_block(128, 64, kernel=5, stride=2),
