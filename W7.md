...
__Résultats__ :
  - DCGAN seuil=0.25: Deux pics, après le dernier le model collapse. Peut de variation dans le temps mais plus qu'avec seuil=0.50 .
		Time=17h35
  - DCGAN seuil=0.50 (gt-0 dcgan2): Losses sans aucun pics et loss de G moins haut qu'avec 0.25. Les images générer sont très stable (Toujours le même nombre d'yeux entre 300 et 1000 epoch) durant l'entrainement. On constate une croube de score sans aucun pic. Autour de 600 on commence à voir apparaitre un même motif en bas à droite de certaine images
		Time=17h30
  - DCGAN seuil=0.75 (gt-2 dcgan2) : Losses avec un pics et loss de G moins haut qu'avec 0.5. Un pics à 800. Les images varies lentement et on voit 2 ou 3 visage reconnaissable. Après 600 epochs plusieurs images partage un motif commun dans leur coin bas à droite.
		Time=17h35

__Conclusion__ :
  - Plus le seuil est élever moins le loss de G est élever, une fois le loss arriver proche de sont point maximum les images ne s'amèliore plus
  - Les motis apparus avec seuil = 0.5 et 0.75 semblent être lier à la complexité du fond dans le dataset. D doit avoir du mal à analyser ces petit détails et G en profite. 
  - La quelité des images ne semble pas liée au seuil. 
