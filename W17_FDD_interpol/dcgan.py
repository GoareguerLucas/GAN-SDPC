...
parser.add_argument("--lrG", type=float, default=0.0005, help="adam: learning rate for G")
...
dataloader = load_data(depth + "../../FDD/kbc/", opt.img_size, opt.batch_size, rand_hflip=True)
