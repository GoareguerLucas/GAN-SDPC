...
see_rsync:
	rsync -avhuzn . albert@147.94.234.244:~/Bureau/Lucas/GAN-SDPC/ --exclude-from=ExclusionRSync

rsync:
	rsync -avhuz . albert@147.94.234.244:~/Bureau/Lucas/GAN-SDPC/ --exclude-from=ExclusionRSync
