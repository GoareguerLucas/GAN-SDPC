...
see_rsync:
	rsync -avhuzn . albert@147.94.234.198:~/Bureau/Lucas/GAN-SDPC/ --exclude-from=ExclusionRSync

rsync:
	rsync -avhuz . albert@147.94.234.198:~/Bureau/Lucas/GAN-SDPC/ --exclude-from=ExclusionRSync
