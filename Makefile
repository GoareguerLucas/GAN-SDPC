...
see_rsync:
	rsync -avhuzn . albert@139.124.208.126:~/Bureau/Lucas/GAN-SDPC/ --exclude-from=ExclusionRSync

rsync:
	rsync -avhuz . albert@139.124.208.126:~/Bureau/Lucas/GAN-SDPC/ --exclude-from=ExclusionRSync
