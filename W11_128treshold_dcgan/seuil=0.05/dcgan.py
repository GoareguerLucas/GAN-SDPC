...
parser.add_argument("-s", "--sample_interval", type=int, default=4, help="interval between image sampling")
...
parser.add_argument("-t","--treshold", type=float, default=0.05, help="Seuil de renforcement [0.0-0.5]")
