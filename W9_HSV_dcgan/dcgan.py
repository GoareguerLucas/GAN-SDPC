...
dataloader = load_data(depth+"../../cropped/cp/",opt.img_size,opt.batch_size,rand_hflip=True,mode="HSV")
...
print("[Total Time: ",durer.tm_mday-1,"j:",time.strftime("%Hh:%Mm:%Ss",durer),"]")
