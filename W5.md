...
![W5_DCGAN 10](W5_mini_dcgan/10.png "Mini DCGAN early")
...
__Résultats__ :
  - DCGAN (gt-0): Les scores sont plus cohérent avec ce qu'on pourrait attendre (D(x)->0.9 et D(G(x))->0.0) ou en tout cas il converge plus vite vers ces valeurs attendue. Le loss_G grimpe plus vite et plus haut (5).  Les images sont beaucoup moins nette sans le dropout.
		Time=50m
...
![W5_DCGAN final](W5_dropout_dcgan/0.0/final.png "Dropout DCGAN")
...
__Résultats__ :
  - DCGAN (gt-2): Le loss de G augmente moins vite qu'avec BCE standard (ce qui est bien). Les imges sont couverte d'un bruit, elles sont moins "belle" qu'avec BCE standard. 
		Time=30
