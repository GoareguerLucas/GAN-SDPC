...
parser.add_argument("-t","--treshold", type=int, default=6, help="Nombre de faux exemples dans les batch générer (<= batch_size)")
...
for j, epoch in enumerate(range(start_epoch,opt.n_epochs+1)):
	...
	for i, (imgs, _) in enumerate(dataloader):
		...
		# Real batch
		#Discriminator descision
		d_x = discriminator(half_real_images)
		# Measure discriminator's ability to classify real from generated samples
