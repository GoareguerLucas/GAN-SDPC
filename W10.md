...
__Résultats__ :
  - Rotate : Des coins noirs apparaisse sur les images dû aux rotations. Scores et losses (lossG surtout) augmente un peut moins rapidement. On constate un pics vers 135e mais pas de collapse. Les images sont moins nette et moins bien former qu'avec juste HRF.
		Time=1h10m
  - Scale (gt-0 dcgan2): Les scores sont quasi identique à ceux de HRF.
		Time=1h5m
  - Both (gt-0 dcgan3): Le lossG augmente moins vite et va moins haut. Les scores sont plus proche et s'éloignent moins vite (D(x)=0.8 à 200epochs contre 0.9 pour HRF seul). Les images sont moins bonne et contiennent plus d'artefacts. L'effet des coins noirs de la rotation est moins présent, dû au scale.
		Time=1h10m
...
![W9_DCGAN Rotate](W10_affine_dcgan/Rotate/200.png "Rotate")
![W9_DCGAN Rotate](W10_affine_dcgan/Scale/200.png "Scale")
![W9_DCGAN Rotate](W10_affine_dcgan/Both/200.png "Both")
...
Comparable avec W8_HRF_dcgan

__Résultats__ :
  - Light (gt-2 dcgan2): #Le lossG augmente moins vite mais sur une pente plus linéaire. Les scores sont plus proche et s'éloignent moins vite (D(x)=0.8 à 200epochs contre 0.9 pour HRF seul). Les images ne sont pas meilleurs voir même moins bonnes.
		Time=1h
  - Clear : Courbes très proche de HRF mis à par deux pics (les pics habituels) sans collapse. Images comparable à HRF.
		Time=1h5m
